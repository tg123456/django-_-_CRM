...
class MyPage(object):
    ...
    def ret_html(self):
        ...
        self.params["page"] = 1
        first_page_tag = '<li><a href="?{}">首页</a></li>'.format(self.params.urlencode())

        self.params["page"] = self.total_page_num
        last_page_tag = '<li><a href="?{}">尾页</a></li>'.format(self.params.urlencode())

        self.params["page"] = self.page_num - 1
        front_page_tag = '<li><a href="?{}">&laquo;</a></li>'.format(self.params.urlencode())

        self.params["page"] = self.page_num + 1
        next_page_tag = '<li><a href="?{}">&raquo;</a></li>'.format(self.params.urlencode())
